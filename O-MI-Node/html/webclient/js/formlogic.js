...
(function() {
  ...
  formLogicExt = function($, WebOmi, consts) {
    var genData, my, objChildren;
    my = WebOmi.formLogic = {};
    ...
    my.clearResponse = function(doneCallback) {
      ...
      mirror.setValue("");
      return consts.responseDiv.slideUp({
        complete: function() {
    ...
    return consts.afterJquery(function() {
      ...
      consts.convertXmlCheckbox.on('change', function() {
        ...
        if (this.checked) {
          ...
          formLogic.setResponse(window.responseXml);
          return consts.responseCodeMirror.addOverlay(consts.URLHighlightOverlay);
        }
      });

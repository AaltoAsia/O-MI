...
`
    ...
    my.params = {
      ...
      ttl: updateSetterForAttr("ttl", "omi:omiEnvelope"), // double
      callback: updateSetterForAttr("callback", "omi:omiEnvelope/*"), // Maybe String
      requestID: { // Maybe Int
        update: function(newVal) {
...
// add
      ...
      interval: updateSetterForAttr("interval", "omi:omiEnvelope/*"), // Maybe Number
      newest: updateSetterForAttr("newest", "omi:omiEnvelope/*"), // Maybe Int
      oldest: updateSetterForAttr("oldest", "omi:omiEnvelope/*"), // Maybe Int
      begin: updateSetterForAttr("begin", "omi:omiEnvelope/*"), // Maybe Date
      end: updateSetterForAttr("end", "omi:omiEnvelope/*"), // Maybe Date

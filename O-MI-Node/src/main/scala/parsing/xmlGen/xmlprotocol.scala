...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit val fromAnySchemaType: scala.xml.Elem => Option[scalaxb.DataRecord[Any]] = { elem =>
    ...
    (key, ns) match {
      case (Some("Objects"), Some("http://www.opengroup.org/xsd/odf/1.0/") | None) => Some(DataRecord(ns,
        key,
        xsns,
        xstype,
        fromXML[ObjectsType](elem)))
      case (Some("omiEnvelope"), Some("http://www.opengroup.org/xsd/omi/1.0/") | None) => Some(DataRecord(ns,
        key,
        xsns,
        xstype,
        fromXML[OmiEnvelopeType](elem)))
  ...
  trait DefaultGenerated_ObjectsTypeFormat extends scalaxb.ElemNameParser[ObjectsType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ObjectsType] =
      phrase(safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/odf/1.0/"), "Object")) ^^ { case p1 =>
        ObjectsType(p1 map {
          scalaxb.fromXML[ObjectType](_, scalaxb.ElemName(node) :: stack)
        },
          scala.collection.immutable.ListMap(List(
            (node \ "@version").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@version" -> _
              }
    ...
    override def writesAttribute(__obj: ObjectsType, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      ...
      __obj.attributes.toList map {
        case ("@version", _) => __obj.version foreach
          { x => attr = scala.xml.Attribute(null, "version", x.toString, attr) }
    ...
    def writesChildNodes(__obj: ObjectsType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.ObjectValue flatMap {
        scalaxb.toXML[ObjectType](_, Some("http://www.opengroup.org/xsd/odf/1.0/"), Some("Object"), __scope, false)
      })
  ...
  trait DefaultGenerated_ObjectTypeFormat extends scalaxb.ElemNameParser[ObjectType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ObjectType] =
      phrase(safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/odf/1.0/"), "id")) ~
        ...
        { case p1 ~ p2 ~ p3 ~ p4 =>
          ObjectType(p1 map {
            scalaxb.fromXML[QlmIDType](_, scalaxb.ElemName(node) :: stack)
          },
            p2 map {
              scalaxb.fromXML[DescriptionType](_, scalaxb.ElemName(node) :: stack)
            },
            p3 map {
              scalaxb.fromXML[InfoItemType](_, scalaxb.ElemName(node) :: stack)
            },
            p4 map {
              scalaxb.fromXML[ObjectType](_, scalaxb.ElemName(node) :: stack)
            },
    ...
    def writesChildNodes(__obj: ObjectType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.id flatMap {
        scalaxb.toXML[QlmIDType](_, Some("http://www.opengroup.org/xsd/odf/1.0/"), Some("id"), __scope, false)
      },
        __obj.description flatMap {
          scalaxb.toXML[DescriptionType](_,
            Some("http://www.opengroup.org/xsd/odf/1.0/"),
            Some("description"),
            __scope,
            false)
        },
        __obj.InfoItem flatMap {
          scalaxb.toXML[InfoItemType](_,
            Some("http://www.opengroup.org/xsd/odf/1.0/"),
            Some("InfoItem"),
            __scope,
            false)
  ...
  trait DefaultGenerated_InfoItemTypeFormat extends scalaxb.ElemNameParser[InfoItemType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[InfoItemType] =
      phrase(safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/odf/1.0/"), "name")) ~
        ...
        safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/odf/1.0/"), "value")) ^^ { case p1 ~ p2 ~ p3 ~ p4 =>
        InfoItemType(p1 map {
          scalaxb.fromXML[QlmIDType](_, scalaxb.ElemName(node) :: stack)
        },
          p2 map {
          ...
          p3 map {
            scalaxb.fromXML[MetaDataType](_, scalaxb.ElemName(node) :: stack)
          },
          p4 map {
            scalaxb.fromXML[ValueType](_, scalaxb.ElemName(node) :: stack)
          },
          scala.collection.immutable.ListMap(List(
    ...
    def writesChildNodes(__obj: InfoItemType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.iname flatMap {
        scalaxb.toXML[QlmIDType](_, Some("http://www.opengroup.org/xsd/odf/1.0/"), Some("name"), __scope, false)
      },
        __obj.description flatMap {
          scalaxb.toXML[DescriptionType](_,
            Some("http://www.opengroup.org/xsd/odf/1.0/"),
        ...
        __obj.MetaData flatMap {
          scalaxb.toXML[MetaDataType](_,
            Some("http://www.opengroup.org/xsd/odf/1.0/"),
            Some("MetaData"),
            __scope,
            false)
        ...
        __obj.value flatMap {
          scalaxb.toXML[ValueType](_, Some("http://www.opengroup.org/xsd/odf/1.0/"), Some("value"), __scope, false)
        })
  ...
  trait DefaultGenerated_MetaDataTypeFormat extends scalaxb.ElemNameParser[MetaDataType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[MetaDataType] =
      phrase(safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/odf/1.0/"), "InfoItem")) ^^ { case p1 =>
        MetaDataType(p1 map {
          scalaxb.fromXML[InfoItemType](_, scalaxb.ElemName(node) :: stack)
        })
      })
    ...
    def writesChildNodes(__obj: MetaDataType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.InfoItem flatMap {
        scalaxb.toXML[InfoItemType](_, Some("http://www.opengroup.org/xsd/odf/1.0/"), Some("InfoItem"), __scope, false)
      })

  }

  trait DefaultGenerated_DescriptionTypeFormat extends
    scalaxb.XMLFormat[DescriptionType] with
  ...
  trait DefaultGenerated_QlmIDTypeFormat extends
    ...
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, QlmIDType] = seq match {
      case node: scala.xml.Node => Right(QlmIDType(scalaxb.fromXML[String](node, scalaxb.ElemName(node) :: stack),
        scala.collection.immutable.ListMap(List(
          (node \ "@idType").headOption map
            { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
            {
              "@idType" -> _
            },
          (node \ "@tagType").headOption map
            { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
            {
              "@tagType" -> _
            },
          (node \ "@startDate").headOption map
            { x => scalaxb
              .DataRecord(x,
                node,
                scalaxb.fromXML[javax.xml.datatype.XMLGregorianCalendar](x, scalaxb.ElemName(node) :: stack))
            } map
            {
              "@startDate" -> _
            },
          (node \ "@endDate").headOption map
            { x => scalaxb
              .DataRecord(x,
                node,
                scalaxb.fromXML[javax.xml.datatype.XMLGregorianCalendar](x, scalaxb.ElemName(node) :: stack))
    ...
    override def writesAttribute(__obj: QlmIDType, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@idType", _) => __obj.idType foreach
          { x => attr = scala.xml.Attribute(null, "idType", x.toString, attr) }
        case ("@tagType", _) => __obj.tagType foreach
          { x => attr = scala.xml.Attribute(null, "tagType", x.toString, attr) }
        case ("@startDate", _) => __obj.startDate foreach
          { x => attr = scala.xml.Attribute(null, "startDate", x.toString, attr) }
        case ("@endDate", _) => __obj.endDate foreach
          { x => attr = scala.xml.Attribute(null, "endDate", x.toString, attr) }
        case (key, x) => attr = scala.xml.Attribute((x.namespace map {
          __scope.getPrefix(_)
        }).orNull, x.key.orNull, x.value.toString, attr)
      }
  ...
  trait DefaultGenerated_ValueTypeFormat extends scalaxb.ElemNameParser[ValueType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ValueType] =
      phrase(optTextRecord ~
        (opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/odf/1.0/"), "Objects")) ^^
          (_ map
            { x => scalaxb
              .DataRecord(x.namespace, Some(x.name), scalaxb.fromXML[ObjectsType](x, scalaxb.ElemName(node) :: stack))
            })) ~
        optTextRecord ^^ { case p1 ~ p2 ~ p3 =>
        ValueType(Seq.concat(p1.toList,
          p2.toList,
          p3.toList),
          scala.collection.immutable.ListMap(List(
            (node \ "@type").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } orElse
              Some(scalaxb
                .DataRecord(None,
                  None,
                  scalaxb.fromXML[String](scala.xml.Text("xs:string"), scalaxb.ElemName(node) :: stack))) map
              {
                "@type" -> _
              },
            (node \ "@dateTime").headOption map
              { x => scalaxb
                .DataRecord(x,
                  node,
                  scalaxb.fromXML[javax.xml.datatype.XMLGregorianCalendar](x, scalaxb.ElemName(node) :: stack))
            ...
            (node \ "@unixTime").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[Long](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@unixTime" -> _
              }
          ).flatten[(String, scalaxb.DataRecord[Any])] ::: (node match {
    ...
    override def writesAttribute(__obj: ValueType, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@type", _) => if (__obj.typeValue.toString != "xs:string") attr = scala.xml
          .Attribute(null, "type", __obj.typeValue.toString, attr)
        case ("@dateTime", _) => __obj.dateTime foreach
          { x => attr = scala.xml.Attribute(null, "dateTime", x.toString, attr) }
        case ("@unixTime", _) => __obj.unixTime foreach
          { x => attr = scala.xml.Attribute(null, "unixTime", x.toString, attr) }
        case (key, x) => attr = scala.xml.Attribute((x.namespace map {
          __scope.getPrefix(_)
        }).orNull, x.key.orNull, x.value.toString, attr)
      }
  ...
  trait DefaultGenerated_OmiEnvelopeTypeFormat extends scalaxb.ElemNameParser[OmiEnvelopeType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[OmiEnvelopeType] =
      phrase((((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "read")) ^^
        (x => scalaxb
          .DataRecord(x.namespace,
            Some(x.name),
            scalaxb.fromXML[ReadRequestType](x, scalaxb.ElemName(node) :: stack)))) |
        ((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "write")) ^^
          (x => scalaxb
            .DataRecord(x.namespace,
              Some(x.name),
              scalaxb.fromXML[WriteRequestType](x, scalaxb.ElemName(node) :: stack)))) |
        ((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "response")) ^^
          (x => scalaxb
            .DataRecord(x.namespace,
              Some(x.name),
              scalaxb.fromXML[ResponseListType](x, scalaxb.ElemName(node) :: stack)))) |
        ((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "cancel")) ^^
          (x => scalaxb
            .DataRecord(x.namespace,
              Some(x.name),
              scalaxb.fromXML[CancelRequestType](x, scalaxb.ElemName(node) :: stack)))) |
        ((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "call")) ^^
          (x => scalaxb
            .DataRecord(x.namespace,
              Some(x.name),
              scalaxb.fromXML[CallRequestType](x, scalaxb.ElemName(node) :: stack)))) |
        ((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "delete")) ^^
          (x => scalaxb
            .DataRecord(x.namespace,
              Some(x.name),
              scalaxb.fromXML[DeleteRequestType](x, scalaxb.ElemName(node) :: stack))))) ^^ { case p1 =>
        OmiEnvelopeType(p1,
          scala.collection.immutable.ListMap(List(
            (node \ "@version").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
    ...
    def writesChildNodes(__obj: OmiEnvelopeType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      ((Some(__obj.omienvelopetypeoption) map
        { x => scalaxb.toXML[scalaxb.DataRecord[OmiEnvelopeTypeOption]](x, x.namespace, x.key, __scope, false) }).get)
  ...
  trait DefaultGenerated_MsgTypeFormat extends scalaxb.ElemNameParser[MsgType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[MsgType] =
      phrase(optTextRecord ~
        safeRep(((any(_.namespace != Some("http://www.opengroup.org/xsd/omi/1.0/")) ^^
    ...
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, RequestBaseType] = seq match {
      case node: scala.xml.Node =>
        scalaxb.Helper.instanceType(node) match {
          case (Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("DeleteRequestType")) => Right(scalaxb
            .fromXML[DeleteRequestType](node, stack))
          case (Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("ReadRequestType")) => Right(scalaxb
            .fromXML[ReadRequestType](node, stack))
          case (Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("WriteRequestType")) => Right(scalaxb
            .fromXML[WriteRequestType](node, stack))
          case (Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("CallRequestType")) => Right(scalaxb
            .fromXML[CallRequestType](node, stack))
  ...
  trait DefaultGenerated_TargetTypeTypeFormat extends scalaxb.XMLFormat[TargetTypeType] {
    ...
    def fromString(value: String, scope: scala.xml.NamespaceBinding): TargetTypeType = scalaxb.fromXML[String](scala.xml
      .Text(value)) match {
  ...
  trait DefaultGenerated_ReadRequestTypeFormat extends scalaxb.ElemNameParser[ReadRequestType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ReadRequestType] =
      phrase(opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "nodeList")) ~
        ...
        opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "msg")) ^^ { case p1 ~ p2 ~ p3 =>
        ReadRequestType(p1.headOption map {
          scalaxb.fromXML[NodesType](_, scalaxb.ElemName(node) :: stack)
        },
          p2 map {
            scalaxb.fromXML[String](_, scalaxb.ElemName(node) :: stack)
          },
          p3.headOption map {
            scalaxb.fromXML[MsgType](_, scalaxb.ElemName(node) :: stack)
          },
          scala.collection.immutable.ListMap(List(
            (node \ "@callback").headOption map
              { x => scalaxb
                .DataRecord(x, node, scalaxb.fromXML[java.net.URI](x, scalaxb.ElemName(node) :: stack))
              } map
              {
                "@callback" -> _
              },
            (node \ "@msgformat").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@msgformat" -> _
              },
            (node \ "@targetType").headOption map
              { x => scalaxb
                .DataRecord(x, node, scalaxb.fromXML[TargetTypeType](x, scalaxb.ElemName(node) :: stack))
              } orElse
              Some(scalaxb
                .DataRecord(None,
                  None,
                  scalaxb.fromXML[TargetTypeType](scala.xml.Text("node"), scalaxb.ElemName(node) :: stack))) map
              {
                "@targetType" -> _
              },
            (node \ "@interval").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@interval" -> _
              },
            (node \ "@oldest").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[BigInt](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@oldest" -> _
              },
            (node \ "@begin").headOption map
              { x => scalaxb
                .DataRecord(x,
                  node,
                  scalaxb.fromXML[javax.xml.datatype.XMLGregorianCalendar](x, scalaxb.ElemName(node) :: stack))
            ...
            (node \ "@newest").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[BigInt](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@newest" -> _
              },
            (node \ "@all").headOption map
              { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[Boolean](x, scalaxb.ElemName(node) :: stack)) } map
              {
                "@all" -> _
              }
          ).flatten[(String, scalaxb.DataRecord[Any])]: _*))
    ...
    override def writesAttribute(__obj: ReadRequestType, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@callback", _) => __obj.callback foreach
          { x => attr = scala.xml.Attribute(null, "callback", x.toString, attr) }
        case ("@msgformat", _) => __obj.msgformat foreach
          { x => attr = scala.xml.Attribute(null, "msgformat", x.toString, attr) }
        case ("@targetType", _) => if (__obj.targetType.toString != "node") attr = scala.xml
          .Attribute(null, "targetType", __obj.targetType.toString, attr)
        case ("@interval", _) => __obj.interval foreach
          { x => attr = scala.xml.Attribute(null, "interval", x.toString, attr) }
        case ("@oldest", _) => __obj.oldest foreach
          { x => attr = scala.xml.Attribute(null, "oldest", x.toString, attr) }
        ...
        case ("@newest", _) => __obj.newest foreach
          { x => attr = scala.xml.Attribute(null, "newest", x.toString, attr) }
    ...
    def writesChildNodes(__obj: ReadRequestType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.nodeList map {
        scalaxb.toXML[NodesType](_, Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("nodeList"), __scope, false)
      } getOrElse Nil,
        __obj.requestID flatMap {
          scalaxb.toXML[String](_, Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("requestID"), __scope, false)
        },
        __obj.msg map {
          scalaxb.toXML[MsgType](_, Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("msg"), __scope, false)
        } getOrElse Nil)
  ...
  trait DefaultGenerated_WriteRequestTypeFormat extends scalaxb.ElemNameParser[WriteRequestType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[WriteRequestType] =
      phrase(opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "nodeList")) ~
        safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "requestID")) ~
        opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "msg")) ^^ { case p1 ~ p2 ~ p3 =>
        WriteRequestType(p1.headOption map {
          scalaxb.fromXML[NodesType](_, scalaxb.ElemName(node) :: stack)
        },
          p2 map {
            scalaxb.fromXML[String](_, scalaxb.ElemName(node) :: stack)
  ...
  trait DefaultGenerated_ResponseListTypeFormat extends scalaxb.ElemNameParser[ResponseListType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ResponseListType] =
      phrase(safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "result")) ^^ { case p1 =>
        ResponseListType(p1 map {
          scalaxb.fromXML[RequestResultType](_, scalaxb.ElemName(node) :: stack)
        })
      })

    def writesChildNodes(__obj: ResponseListType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.result flatMap {
        scalaxb.toXML[RequestResultType](_,
          Some("http://www.opengroup.org/xsd/omi/1.0/"),
          Some("result"),
          __scope,
          false)
      })
  ...
  trait DefaultGenerated_CallRequestTypeFormat extends scalaxb.ElemNameParser[CallRequestType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[CallRequestType] =
      phrase(opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "nodeList")) ~
        safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "requestID")) ~
        opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "msg")) ^^ { case p1 ~ p2 ~ p3 =>
        CallRequestType(p1.headOption map {
          scalaxb.fromXML[NodesType](_, scalaxb.ElemName(node) :: stack)
        },
          p2 map {
            scalaxb.fromXML[String](_, scalaxb.ElemName(node) :: stack)
  ...
  trait DefaultGenerated_DeleteRequestTypeFormat extends scalaxb.ElemNameParser[DeleteRequestType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[DeleteRequestType] =
      phrase(opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "nodeList")) ~
        safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "requestID")) ~
        opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "msg")) ^^ { case p1 ~ p2 ~ p3 =>
        DeleteRequestType(p1.headOption map {
          scalaxb.fromXML[NodesType](_, scalaxb.ElemName(node) :: stack)
        },
          p2 map {
            scalaxb.fromXML[String](_, scalaxb.ElemName(node) :: stack)
  ...
  trait DefaultGenerated_RequestResultTypeFormat extends scalaxb.ElemNameParser[RequestResultType] {
      ...
      phrase((scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "return")) ~
        ...
        { case p1 ~ p2 ~ p3 ~ p4 ~ p5 =>
          RequestResultType(scalaxb.fromXML[ReturnType](p1, scalaxb.ElemName(node) :: stack),
            p2 map {
              scalaxb.fromXML[IdType](_, scalaxb.ElemName(node) :: stack)
            },
            p3.headOption map {
              scalaxb.fromXML[MsgType](_, scalaxb.ElemName(node) :: stack)
            },
            ...
            p5.headOption map {
              scalaxb.fromXML[OmiEnvelopeType](_, scalaxb.ElemName(node) :: stack)
            },
            scala.collection.immutable.ListMap(List(
              (node \ "@msgformat").headOption map
                { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
    ...
    def writesChildNodes(__obj: RequestResultType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq
        .concat(scalaxb.toXML[ReturnType](__obj.returnValue,
          Some("http://www.opengroup.org/xsd/omi/1.0/"),
          Some("return"),
          __scope,
          false),
          __obj.requestID flatMap {
            scalaxb.toXML[IdType](_, Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("requestID"), __scope, false)
          },
          __obj.msg map {
            scalaxb.toXML[MsgType](_, Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("msg"), __scope, false)
          } getOrElse Nil,
          ...
          __obj.omiEnvelope map {
            scalaxb.toXML[OmiEnvelopeType](_,
              Some("http://www.opengroup.org/xsd/omi/1.0/"),
              Some("omiEnvelope"),
              __scope,
              false)
  ...
  trait DefaultGenerated_ReturnTypeFormat extends
    scalaxb.XMLFormat[ReturnType] with
    ...
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, ReturnType] = seq match {
      case node: scala.xml.Node => Right(ReturnType(scalaxb.fromXML[String](node, scalaxb.ElemName(node) :: stack),
        scala.collection.immutable.ListMap(List(
          (node \ "@returnCode").headOption map
            { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
            {
              "@returnCode" -> _
            },
          (node \ "@description").headOption map
            { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map
            {
              "@description" -> _
            }
    ...
    override def writesAttribute(__obj: ReturnType, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      ...
      __obj.attributes.toList map {
        ...
        case ("@description", _) => __obj.description foreach
          { x => attr = scala.xml.Attribute(null, "description", x.toString, attr) }
        case (key, x) => attr = scala.xml.Attribute((x.namespace map {
          __scope.getPrefix(_)
        }).orNull, x.key.orNull, x.value.toString, attr)
      }
  ...
  trait DefaultGenerated_NodesTypeFormat extends scalaxb.ElemNameParser[NodesType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[NodesType] =
      phrase(safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "node")) ^^ { case p1 =>
        NodesType(p1 map {
    ...
    def writesChildNodes(__obj: NodesType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.node flatMap {
        scalaxb.toXML[java.net.URI](_, Some("http://www.opengroup.org/xsd/omi/1.0/"), Some("node"), __scope, false)
      })
  ...
  trait DefaultGenerated_IdTypeFormat extends scalaxb.XMLFormat[IdType] with scalaxb.CanWriteChildNodes[IdType] {
    ...
    override def writesAttribute(__obj: IdType, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@format", _) => __obj.format foreach
          { x => attr = scala.xml.Attribute(null, "format", x.toString, attr) }
        case (key, x) => attr = scala.xml.Attribute((x.namespace map {
          __scope.getPrefix(_)
        }).orNull, x.key.orNull, x.value.toString, attr)
      }
  ...
  trait DefaultGenerated_CancelRequestTypeFormat extends scalaxb.ElemNameParser[CancelRequestType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[CancelRequestType] =
      phrase(opt(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "nodeList")) ~
        safeRep(scalaxb.ElemName(Some("http://www.opengroup.org/xsd/omi/1.0/"), "requestID")) ^^ { case p1 ~ p2 =>
        CancelRequestType(p1.headOption map {
          scalaxb.fromXML[NodesType](_, scalaxb.ElemName(node) :: stack)
        },
          p2 map {
            scalaxb.fromXML[IdType](_, scalaxb.ElemName(node) :: stack)

...
4. (_optional step_) you can also download packaged version from git releases: [zip](https://github.com/AaltoAsia/O-MI/releases/download/0.1.7-SNAPSHOT/o-mi-node-0.1.7-SNAPSHOT.zip) [tar](https://github.com/AaltoAsia/O-MI/releases/download/0.1.7-SNAPSHOT/o-mi-node-0.1.7-SNAPSHOT.tgz)

...
(function() {
  ...
  formLogicExt = function($, WebOmi) {
    ...
    my.handleSubscriptionHistory = function(responseString) {
      var addHistory, cbSub, cloneElem, createHistory, getPath, getPathValues, htmlformat, info, infoitems, maybeRequestID, omi, pathValues, requestID, response, returnStatus;
      omi = WebOmi.omi;
      ...
      htmlformat = function(pathValues) {
        var i, len, lines, pathValue, pathValuePairs, results, row;
        ...
        for (i = 0, len = lines.length; i < len; i++) {
          pathValue = lines[i];
          row = $("<tr/>").append($("<td/>")).append($("<td/>").text(pathValue.path)).append($("<td/>").text(pathValue.value));
          results.push(row);
        }
        return results;
      };
      addHistory = function(requestID, pathValues) {
        var callbackRecord, dataTable, maybeCBRecord, newHistory, returnS;
        ...
        if (maybeCBRecord.selector != null) {
          ...
          dataTable.append(returnS).append(htmlformat(pathValues));

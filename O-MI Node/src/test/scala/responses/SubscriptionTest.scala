  ...
  "SubscriptionHandler" should {
   /* "return code 200 for successful subscription" >> {
    ...
    "return only events for new infoitems and objects for interval -2 subscriptions" >> {
      ...
      addValue("p/1", nv("5",40000)) //existing paths
      addValue("p/2", nv("5",40000))//existing paths
      addValue("p/3", nv("5",40000))//existing paths
      val c1 = pollValues(subId0) must have size(0)
      addValue("p/4", nv("5",40000))//correct path 1
      addValue("p/s/5", nv("5",40000))//correct path 2
      addValue("r/5", nv("5",40000))//wrong path
      addValue("r/2", nv("5",40000))//wrong path

...
object SQLiteTest extends Specification {
  ...
  "SQLite" should {
    ...
    "be able to buffer data on demand"in{
      database.SQLite.startBuffering("path/to/sensor3/temp")
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.0C",new java.sql.Timestamp(6000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.1C",new java.sql.Timestamp(7000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.1C",new java.sql.Timestamp(8000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.2C",new java.sql.Timestamp(9000)))
      ...
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.5C",new java.sql.Timestamp(16000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(17000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(18000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(19000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(20000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(21000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(22000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(23000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(24000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(25000)))
      database.SQLite.set(DBSensor("path/to/sensor3/temp","21.6C",new java.sql.Timestamp(26000)))
      database.SQLite.getNLatest("path/to/sensor3/temp",21).length shouldEqual 21
    }
    "be able to stop buffering and revert to using historyLenght" in
    {
      database.SQLite.stopBuffering("path/to/sensor3/temp")
      database.SQLite.getNLatest("path/to/sensor3/temp",21).length shouldEqual 10
    }
    "return true when removing valid path" in{
      database.SQLite.remove("path/to/sensor3/temp")

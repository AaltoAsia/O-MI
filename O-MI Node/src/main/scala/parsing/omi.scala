...
/** Return status of request. Use HTTP codes /
...
/** The nodesType is used anywhere in the schema
	    where lists of nodes can appear. 
*/
case class NodesType(node: Seq[java.net.URI] = Nil,
  typeValue: Option[String] = None)


/** Some kind of identifier with optional "format"
	    attribute for indicating what kind of identifier is used. 
*/

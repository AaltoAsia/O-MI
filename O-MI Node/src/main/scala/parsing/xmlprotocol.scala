...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  trait DefaultObjectsTypeFormat extends scalaxb.ElemNameParser[ObjectsType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ObjectsType] =
      phrase(rep(scalaxb.ElemName(None, "Object")) ^^
      { case p1 =>
    ...
    def writesChildNodes(__obj: ObjectsType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.Object flatMap { scalaxb.toXML[ObjectType](_, None, Some("Object"), __scope, false) })
  ...
  trait DefaultObjectTypeFormat extends scalaxb.ElemNameParser[ObjectType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[ObjectType] =
      phrase(rep(scalaxb.ElemName(None, "id")) ~ 
      opt(scalaxb.ElemName(None, "description")) ~ 
      rep(scalaxb.ElemName(None, "InfoItem")) ~ 
      rep(scalaxb.ElemName(None, "Object")) ^^
      { case p1 ~ p2 ~ p3 ~ p4 =>
    ...
    def writesChildNodes(__obj: ObjectType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.id flatMap { scalaxb.toXML[QlmID](_, None, Some("id"), __scope, false) },
        __obj.description map { scalaxb.toXML[Description](_, None, Some("description"), __scope, false) } getOrElse {Nil},
        __obj.InfoItem flatMap { scalaxb.toXML[InfoItemType](_, None, Some("InfoItem"), __scope, false) },
        __obj.Object flatMap { scalaxb.toXML[ObjectType](_, None, Some("Object"), __scope, false) })
  ...
  trait DefaultMetaDataFormat extends scalaxb.ElemNameParser[MetaData] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[MetaData] =
      phrase(rep(scalaxb.ElemName(None, "InfoItem")) ^^
      { case p1 =>
  ...
  trait DefaultInfoItemTypeFormat extends scalaxb.ElemNameParser[InfoItemType] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[InfoItemType] =
      phrase(rep(scalaxb.ElemName(None, "name")) ~ 
      opt(scalaxb.ElemName(None, "description")) ~ 
      opt(scalaxb.ElemName(None, "MetaData")) ~ 
    ...
    def writesChildNodes(__obj: InfoItemType, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.otherName flatMap { scalaxb.toXML[QlmID](_, None, Some("name"), __scope, false) },
        __obj.description map { scalaxb.toXML[Description](_, None, Some("description"), __scope, false) } getOrElse {Nil},
        __obj.MetaData map { scalaxb.toXML[MetaData](_, None, Some("MetaData"), __scope, false) } getOrElse {Nil},
        __obj.value flatMap { scalaxb.toXML[ValueType](_, None, Some("value"), __scope, false) })
